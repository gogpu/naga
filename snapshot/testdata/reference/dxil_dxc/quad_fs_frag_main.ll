...
; u_texture                         texture     f32          2d      T0             t0     1
...
; <label>:16                                      ; preds = %R14, %R16
  %R17 = fmul fast float %R12, %R9
  %R18 = fmul fast float %R12, %R10
  %R19 = fmul fast float %R12, %R11
  %R20 = fmul fast float %R12, %R12
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 0, float %R17)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 1, float %R18)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %R19)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %R20)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  ret void
}
...
declare void @dx.op.discard(i32, i1) #A1

; Function Attrs: nounwind readnone
declare float @dx.op.loadInput.f32(i32, i32, i32, i8, i32) #A2
...
!M6 = !{void ()* @frag_main, !"frag_main", !M14, !M4, !M15}
!M14 = !{!M16, !M17, null}
!M16 = !{!M18}
