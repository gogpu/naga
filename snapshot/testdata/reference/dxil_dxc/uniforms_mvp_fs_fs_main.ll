...
define void @fs_main() {
  ...
  %R3 = call float @dx.op.dot3.f32(i32 55, float %R0, float %R1, float %R2, float %R0, float %R1, float %R2)  ; Dot3(ax,ay,az,bx,by,bz)
  %R4 = call float @dx.op.unary.f32(i32 25, float %R3)  ; Rsqrt(value)
  %R5 = fmul fast float %R4, 5.000000e-01
  %R6 = fmul fast float %R5, %R0
  %R7 = fmul fast float %R5, %R1
  %R8 = fmul fast float %R5, %R2
  %R9 = fadd fast float %R6, 5.000000e-01
  %R10 = fadd fast float %R7, 5.000000e-01
  %R11 = fadd fast float %R8, 5.000000e-01
...
!M2 = !{i32 1, i32 0}
!M3 = !{!"ps", i32 6, i32 0}
!M4 = !{[5 x i32] [i32 3, i32 4, i32 7, i32 7, i32 7]}
!M5 = !{void ()* @fs_main, !"fs_main", !M6, null, null}
!M6 = !{!M7, !M8, null}
!M7 = !{!M9}
!M9 = !{i32 0, !"LOC", i8 9, i8 0, !M10, i8 2, i32 1, i8 3, i32 0, i8 0, !M11}
!M10 = !{i32 0}
!M11 = !{i32 3, i32 7}
!M8 = !{!M12}
!M12 = !{i32 0, !"SV_Target", i8 9, i8 16, !M10, i8 0, i32 1, i8 4, i32 0, i8 0, !M13}
!M13 = !{i32 3, i32 15}
