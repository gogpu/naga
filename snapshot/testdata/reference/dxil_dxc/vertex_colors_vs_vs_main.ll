...
define void @vs_main() {
  ...
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 0, float %R3)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 1, float %R4)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 2, float %R5)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
...
!M2 = !{i32 1, i32 8}
!M3 = !{!"vs", i32 6, i32 0}
!M4 = !{[9 x i32] [i32 7, i32 8, i32 16, i32 32, i32 64, i32 0, i32 1, i32 2, i32 4]}
!M5 = !{void ()* @vs_main, !"vs_main", !M6, null, null}
!M6 = !{!M7, !M8, null}
!M7 = !{!M9, !M10}
!M9 = !{i32 0, !"LOC", i8 9, i8 0, !M11, i8 0, i32 1, i8 3, i32 0, i8 0, !M12}
!M11 = !{i32 0}
!M12 = !{i32 3, i32 7}
!M10 = !{i32 1, !"LOC", i8 9, i8 0, !M13, i8 0, i32 1, i8 3, i32 1, i8 0, !M12}
!M13 = !{i32 1}
!M8 = !{!M14, !M15}
!M14 = !{i32 0, !"LOC", i8 9, i8 0, !M11, i8 2, i32 1, i8 3, i32 0, i8 0, !M12}
!M15 = !{i32 1, !"SV_Position", i8 9, i8 3, !M11, i8 4, i32 1, i8 4, i32 1, i8 0, !M16}
!M16 = !{i32 3, i32 15}
