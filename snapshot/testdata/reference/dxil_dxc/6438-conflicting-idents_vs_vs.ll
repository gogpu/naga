...
define void @vs() {
  ...
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 0, float %R0)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 1, i32 0, i8 1, float %R1)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
...
!M2 = !{i32 1, i32 0}
!M3 = !{!"vs", i32 6, i32 0}
!M4 = !{[4 x i32] [i32 2, i32 8, i32 16, i32 32]}
!M5 = !{void ()* @vs, !"vs", !M6, null, null}
!M6 = !{!M7, !M8, null}
!M7 = !{!M9}
!M9 = !{i32 0, !"LOC", i8 9, i8 0, !M10, i8 0, i32 1, i8 2, i32 0, i8 0, !M11}
!M10 = !{i32 0}
!M11 = !{i32 3, i32 3}
!M8 = !{!M12, !M13}
!M12 = !{i32 0, !"LOC", i8 9, i8 0, !M10, i8 2, i32 1, i8 2, i32 0, i8 0, !M11}
!M13 = !{i32 1, !"SV_Position", i8 9, i8 3, !M10, i8 4, i32 1, i8 4, i32 1, i8 0, !M14}
!M14 = !{i32 3, i32 15}
