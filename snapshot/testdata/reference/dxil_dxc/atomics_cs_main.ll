...
@"\01?shared_counter@@3IA" = external addrspace(3) global i32, align 4
...
; <label>:13                                      ; preds = %R12, %R9
  %R14 = phi i1 [ %R11, %R12 ], [ false, %R9 ]
  call void @dx.op.barrier(i32 80, i32 9)  ; Barrier(barrierMode)
  %R15 = atomicrmw add i32 addrspace(3)* @"\01?shared_counter@@3IA", i32 1 seq_cst
  call void @dx.op.barrier(i32 80, i32 9)  ; Barrier(barrierMode)
...
declare i32 @dx.op.flattenedThreadIdInGroup.i32(i32) #A3
