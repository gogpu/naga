...
; -------------------- ----- ------ -------- -------- ------- ------
; LOC                      0   xyz         0     NONE   float
; LOC                      1      w        0     NONE   float
;
;
; Output signature:
;
...
; EntryFunctionName: no_padding_frag
;
;
; Input signature:
;
...
!M2 = !{i32 1, i32 0}
!M3 = !{!"ps", i32 6, i32 0}
!M4 = !{[6 x i32] [i32 4, i32 4, i32 0, i32 0, i32 0, i32 0]}
!M5 = !{void ()* @no_padding_frag, !"no_padding_frag", !M6, null, null}
!M6 = !{!M7, !M8, null}
!M7 = !{!M9, !M10}
!M9 = !{i32 0, !"LOC", i8 9, i8 0, !M11, i8 2, i32 1, i8 3, i32 0, i8 0, null}
!M11 = !{i32 0}
!M10 = !{i32 1, !"LOC", i8 9, i8 0, !M12, i8 2, i32 1, i8 1, i32 0, i8 3, null}
!M12 = !{i32 1}
!M8 = !{!M13}
