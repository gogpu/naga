...
define void @fs_main() {
  ...
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 2, float %R0)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 0, i8 3, float %R0)  ; StoreOutput(outputSigId,rowIndex,colIndex,value)
  ret void
}
...
!M2 = !{i32 1, i32 0}
!M3 = !{!"ps", i32 6, i32 0}
!M4 = !{[10 x i32] [i32 8, i32 4, i32 3, i32 12, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0]}
!M5 = !{void ()* @fs_main, !"fs_main", !M6, null, null}
!M6 = !{!M7, !M8, null}
!M7 = !{!M9, !M10, !M11}
!M9 = !{i32 0, !"LOC", i8 9, i8 0, !M12, i8 2, i32 1, i8 1, i32 0, i8 0, !M13}
!M12 = !{i32 1}
!M13 = !{i32 3, i32 1}
!M10 = !{i32 1, !"LOC", i8 9, i8 0, !M14, i8 2, i32 1, i8 1, i32 0, i8 1, !M13}
!M14 = !{i32 3}
!M11 = !{i32 2, !"SV_Position", i8 9, i8 3, !M15, i8 4, i32 1, i8 4, i32 1, i8 0, null}
!M15 = !{i32 0}
!M8 = !{!M16}
!M16 = !{i32 0, !"SV_Target", i8 9, i8 16, !M15, i8 0, i32 1, i8 4, i32 0, i8 0, !M17}
!M17 = !{i32 3, i32 15}
