...
; EntryFunctionName: entry_point_one
;
;
; Input signature:
;
...
define void @entry_point_one() {
  ...
  %R4 = call %dx.types.ResRet.i32 @dx.op.bufferLoad.i32(i32 68, %dx.types.Handle %R0, i32 2, i32 0)  ; BufferLoad(srv,index,wot)
...
!M5 = !{[6 x i32] [i32 4, i32 4, i32 15, i32 15, i32 0, i32 0]}
!M6 = !{void ()* @entry_point_one, !"entry_point_one", !M14, !M4, !M15}
!M14 = !{!M16, !M17, null}
!M16 = !{!M18}
!M18 = !{i32 0, !"SV_Position", i8 9, i8 3, !M19, i8 4, i32 1, i8 4, i32 0, i8 0, !M20}
!M19 = !{i32 0}
!M20 = !{i32 3, i32 3}
!M17 = !{!M21}
