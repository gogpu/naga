...
; <label>:8                                       ; preds = %R9
  ...
  %R46 = fcmp fast ogt float %R44, 1.000000e+00
  ...
  %R50 = fcmp fast olt float %R48, -1.000000e+00
  %R51 = fmul fast float %R49, 0xBFE99999A0000000
  %R52 = select i1 %R50, float %R51, float %R49
  %R53 = fcmp fast ogt float %R45, 1.000000e+00
  ...
  %R57 = fcmp fast olt float %R55, -1.000000e+00
