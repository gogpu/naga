...
void test_matrix_within_struct_accesses()
{
    ...
    float l3_ = GetMatmOnBaz(baz)[0][1];
    int _e25 = idx;
    float l4_ = GetMatmOnBaz(baz)[0][_e25];
    int _e30 = idx;
    float l5_ = GetMatmOnBaz(baz)[_e30][1];
    int _e36 = idx;
    int _e38 = idx;
...
void test_matrix_within_array_within_struct_accesses()
{
    ...
    float l4_1 = nested_mat_cx2_.am[0]._0[1];
    int _e33 = idx_1;
    float l5_1 = nested_mat_cx2_.am[0]._0[_e33];
    int _e39 = idx_1;
    float l6_1 = __get_col_of_mat4x2(nested_mat_cx2_.am[0], _e39)[1];
    int _e46 = idx_1;
    int _e48 = idx_1;
