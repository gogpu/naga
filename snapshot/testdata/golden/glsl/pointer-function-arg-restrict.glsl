...
void main() {
    ivec2 vec_1[4] = ivec2[4](ivec2(0), ivec2(0), ivec2(0), ivec2(0));
    mat2x2 mat_1[4] = mat2x2[4](mat2x2(0.0), mat2x2(0.0), mat2x2(0.0), mat2x2(0.0));
    int arr1d_1[4] = int[4](0, 0, 0, 0);
    int arr2d_1[4][4] = int[4][4](int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0));
    int arr3d_1[4][4][4] = int[4][4][4](int[4][4](int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0)), int[4][4](int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0)), int[4][4](int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0)), int[4][4](int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0), int[4](0, 0, 0, 0)));
    local_var(1u);
    mat_vec_ptrs(vec_1, mat_1, 1u);
    argument(arr1d_1, 1u);
    argument_nested_x2_(arr2d_1, 1u, 2u);
    argument_nested_x3_(arr3d_1, 1u, 2u);
    index_from_self(arr1d_1, 1u);
    local_var_from_arg(int[4](1, 2, 3, 4), 5u);
    let_binding(arr1d_1, 1u);
    return;
}
