...
layout(std430) buffer Mat_block_0Compute { mat2x2 _group_0_binding_0_cs; };

layout(std140) uniform Mat_block_1Compute { mat2x2 _group_0_binding_1_cs; };
...
void access_m() {
    ...
    int _e3 = idx;
    idx = (_e3 - 1);
    mat2x2 l_s_m = _group_0_binding_0_cs;
    vec2 l_s_c_c = _group_0_binding_0_cs[0];
    int _e11 = idx;
    vec2 l_s_c_v = _group_0_binding_0_cs[_e11];
    ...
    mat2x2 l_u_m = _group_0_binding_1_cs;
    vec2 l_u_c_c = _group_0_binding_1_cs[0];
    int _e40 = idx;
    vec2 l_u_c_v = _group_0_binding_1_cs[_e40];
...
void access_sm() {
    ...
    mat2x2 l_s_m_1 = _group_1_binding_0_cs.m;
    vec2 l_s_c_c_1 = _group_1_binding_0_cs.m[0];
    int _e16 = idx_1;
    vec2 l_s_c_v_1 = _group_1_binding_0_cs.m[_e16];
    ...
    mat2x2 l_u_m_1 = _group_1_binding_1_cs.m;
    vec2 l_u_c_c_1 = _group_1_binding_1_cs.m[0];
    int _e54 = idx_1;
    vec2 l_u_c_v_1 = _group_1_binding_1_cs.m[_e54];
...
void access_sasm() {
    ...
    mat2x2 l_s_m_c = _group_2_binding_0_cs.a[0].m;
    int _e17 = idx_2;
    mat2x2 l_s_m_v = _group_2_binding_0_cs.a[_e17].m;
    vec2 l_s_c_cc = _group_2_binding_0_cs.a[0].m[0];
    int _e31 = idx_2;
    vec2 l_s_c_cv = _group_2_binding_0_cs.a[0].m[_e31];
    int _e36 = idx_2;
    vec2 l_s_c_vc = _group_2_binding_0_cs.a[_e36].m[0];
    int _e43 = idx_2;
    int _e46 = idx_2;
    vec2 l_s_c_vv = _group_2_binding_0_cs.a[_e43].m[_e46];
    ...
    mat2x2 l_u_m_c = _group_2_binding_1_cs.a[0].m;
    int _e129 = idx_2;
    mat2x2 l_u_m_v = _group_2_binding_1_cs.a[_e129].m;
    vec2 l_u_c_cc = _group_2_binding_1_cs.a[0].m[0];
    int _e143 = idx_2;
    vec2 l_u_c_cv = _group_2_binding_1_cs.a[0].m[_e143];
    int _e148 = idx_2;
    vec2 l_u_c_vc = _group_2_binding_1_cs.a[_e148].m[0];
    int _e155 = idx_2;
    int _e158 = idx_2;
    vec2 l_u_c_vv = _group_2_binding_1_cs.a[_e155].m[_e158];
